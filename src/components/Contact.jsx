    ...
    >
      <form method="POST" action="https://getform.io/f/fdb7e546-c73f-4976-9805-bb32bba7fb67" className="flex flex-col max-w-[600px] w-full">
        <div className="pb-8 pt-8">
          ...
          <p className="text-gray-300 my-8">Submit the form and I will be in touch</p>
        </div>
        <input
      ...
      <a
            ...
            >
              GitHub <span className="px-2"><FaGithub size={30} /></span>
            </a>
            <a
              className="flex justify-between items-center w-full text-gray-300 text-bold px-6"
              href="https://www.linkedin.com/in/lincoln-chadburn-79115a201"
            >
              LinkedIn <span className="px-2"><FaLinkedin size={30} /></span>
            </a>
            <a
              name="email"
              className="flex justify-between items-center w-full text-gray-300 text-bold px-6"
              ...
              href="#email"
            >
              Email <span className="px-2"><HiOutlineMail size={30} /></span>
            </a>
      </div>
    </div>
  );
